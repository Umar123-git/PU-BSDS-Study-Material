...
int maint3()
{
	...
	for(int i=0 ; i<3 ; i++)
	{
    cout << "Roll Number   : " << student[i].getRollnum() << endl;
...
int main()
{
	...
	for(int i=0 ; i<3 ; i++)
	{
	cout << "Course        : " << course [i].getTitle      () << endl;
    cout << "Roll Number   : " << student[i].getRollnum    () << endl;
    cout << "Name          : " << student[i].getName       () << endl;
    cout << "Credits       : " << student[i].getCreditHours() << endl;	
    cout << "Marks         : " << student[i].getMaks       () << endl;	
    cout<<endl;
	}

for(int i=0 ; i<3 ; i++)
{
	sum=sum+student[i].getMaks();
}
	sum=sum/3;
